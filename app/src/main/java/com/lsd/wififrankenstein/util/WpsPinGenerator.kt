...
class WpsPinGenerator {
    ...
    companion object {
        ...
        private val MAC_SEPARATOR_REGEX = Regex("[:.-]")
    }
    ...
    private fun initAlgos() {
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                deviceNames = listOf(
                    "ZyXEL Internet Center", "Keenetic Giga II", "Keenetic Lite III",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                "36-bit PIN",
                ALGO_MAC,
                { mac, _ -> mac % 0x1000000000L },
                description = "Pin = MAC[4..12]"
            )
        )
        algorithms.add(
            WpsAlgorithm(
                ...
                "40-bit PIN",
                ALGO_MAC,
                { mac, _ -> mac % 0x10000000000L },
                description = "Pin = MAC[3..12]"
            )
        )
        algorithms.add(
            WpsAlgorithm(
                ...
                "44-bit PIN",
                ALGO_MAC,
                { mac, _ -> mac % 0x100000000000L },
                description = "Pin = MAC[2..12]"
            )
        )
        algorithms.add(
            WpsAlgorithm(
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                func = { mac, _ ->
                    ...
                    val reversed =
                        macStr.substring(4, 6) + macStr.substring(2, 4) + macStr.substring(0, 2)
                    reversed.toLong(16)
                },
            ...
            WpsAlgorithm(
                ...
                func = { mac, ser ->
                    algoDslMacSn(
                        mac,
                        ser,
                        DslInit(bx = listOf(66, 129, 209, 10, 24, 3, 39))
                    )
                },
            ...
            WpsAlgorithm(
                ...
                func = { mac, ser ->
                    algoDslMacSn(
                        mac - 2,
                        ser,
                        DslInit(bx = listOf(129, 65, 6, 10, 136, 80, 33))
                    )
                },
                prefixes = listOf(
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                "Inv NIC to PIN",
                ALGO_MAC,
                { mac, _ -> (mac and 0xFFFFFFL).inv() and 0xFFFFFFL },
                description = "Pin = Inv(MAC[7..12])"
            )
        )
        algorithms.add(
            WpsAlgorithm(
                "pinNIC2", "NIC * 2", ALGO_MAC,
                { mac, _ -> (mac and 0xFFFFFFL) * 2 }, description = "Pin = MAC[7..12] * 2"
            )
        )
        algorithms.add(
            WpsAlgorithm(
                "pinNIC3", "NIC * 3", ALGO_MAC,
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                deviceNames = listOf(
                    "DIR-620", "DIR-822", "DIR-825AC", "DIR-825ACG1", "DSL-2640U",
    ...
    private fun addStaticPins() {
        algorithms.add(
            WpsAlgorithm(
                ...
                deviceNames = listOf("ASUS Wireless Router", "Atheros AP"),
                description = "Pin = 1234567"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinBrcm1", "Broadcom 1", ALGO_STATIC, { _, _ -> 2017252 },
                prefixes = listOf(
                    "AC:F1:DF",
                    "BC:F6:85",
                    "C8:D3:A3",
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinBrcm2", "Broadcom 2", ALGO_STATIC, { _, _ -> 4626484 },
                prefixes = listOf(
                    "14:D6:4D",
                    "1C:7E:E5",
                    "28:10:7B",
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinBrcm3", "Broadcom 3", ALGO_STATIC, { _, _ -> 7622990 },
                prefixes = listOf(
                    "14:D6:4D",
                    "1C:7E:E5",
                    "28:10:7B",
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinBrcm4", "Broadcom 4", ALGO_STATIC, { _, _ -> 6232714 },
                prefixes = listOf(
                    "14:D6:4D", "1C:7E:E5", "28:10:7B", "84:C9:B2", "B8:A3:86", "BC:F6:85",
                    "C8:BE:19", "C8:D3:A3", "CC:B2:55", "FC:75:16", "20:4E:7F", "4C:17:EB",
                    "18:62:2C", "7C:03:D8", "D8:6C:E9"
                ), description = "Pin = 6232714"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinBrcm5", "Broadcom 5", ALGO_STATIC, { _, _ -> 1086411 },
                prefixes = listOf(
                    "14:D6:4D", "1C:7E:E5", "28:10:7B", "84:C9:B2", "B8:A3:86", "BC:F6:85",
                    "C8:BE:19", "C8:D3:A3", "CC:B2:55", "FC:75:16", "20:4E:7F", "4C:17:EB",
                    "18:62:2C", "7C:03:D8", "D8:6C:E9"
                ), description = "Pin = 1086411"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinBrcm6", "Broadcom 6", ALGO_STATIC, { _, _ -> 3195719 },
                prefixes = listOf(
                    "14:D6:4D", "1C:7E:E5", "28:10:7B", "84:C9:B2", "B8:A3:86", "BC:F6:85",
                    "C8:BE:19", "C8:D3:A3", "CC:B2:55", "FC:75:16", "20:4E:7F", "4C:17:EB",
                    "18:62:2C", "7C:03:D8", "D8:6C:E9"
                ), description = "Pin = 3195719"
            )
        )
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                ALGO_STATIC,
                { _, _ -> 3043203 },
                prefixes = listOf("18:1E:78", "40:F2:01", "44:E9:DD", "D0:84:B0"),
                description = "Pin = 3043203"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinAirc2", "Airocon 2", ALGO_STATIC, { _, _ -> 7141225 },
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinDSL2740R", "DSL-2740R", ALGO_STATIC, { _, _ -> 6817554 },
                prefixes = listOf(
                    "00:26:5A",
                    "1C:BD:B9",
                    "34:08:04",
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinRealtek1", "Realtek 1", ALGO_STATIC, { _, _ -> 9566146 },
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                ALGO_STATIC,
                { _, _ -> 9571911 },
                prefixes = listOf("00:72:63", "E4:BE:ED"),
                deviceNames = listOf("RTK_AP"),
                description = "Pin = 9571911"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinRealtek3", "Realtek 3", ALGO_STATIC, { _, _ -> 4856371 },
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                ALGO_STATIC,
                { _, _ -> 2085483 },
                prefixes = listOf("78:44:76", "D4:BF:7F:0", "F8:C0:91"),
                description = "Pin = 2085483"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinUR814AC", "UR-814AC", ALGO_STATIC, { _, _ -> 4397768 },
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                ALGO_STATIC,
                { _, _ -> 529417 },
                prefixes = listOf("D4:BF:7F:5"),
                deviceNames = listOf("UR-825N4G"),
                description = "Pin = 0529417"
            )
        )
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                deviceNames = listOf("RTK_AP", "RTK_AP_2x", "RTL8196E"),
                description = "Pin = 9995604"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinEdimax", "Edimax", ALGO_STATIC, { _, _ -> 3561153 },
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                ALGO_STATIC,
                { _, _ -> 6795814 },
                prefixes = listOf("00:26:24", "44:32:C8", "88:F7:C7", "CC:03:FA"),
                description = "Pin = 6795814"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinHG532x", "HG532x", ALGO_STATIC, { _, _ -> 3425928 },
                prefixes = listOf(
                    "00:66:4B",
                    "08:63:61",
                    "08:7A:4C",
                    ...
                    "F8:01:13",
                    "F8:3D:FF"
                ), description = "Pin = 3425928"
            )
        )

        algorithms.add(
            WpsAlgorithm(
                "pinH108L", "H108L", ALGO_STATIC, { _, _ -> 9422988 },
                prefixes = listOf(
                    "4C:09:B4",
                    "4C:AC:0A",
                    "84:74:2A:4",
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinONO", "CBN ONO", ALGO_STATIC, { _, _ -> 9575521 },
    ...
    private fun initExperimentalAlgos() {
        algorithms.add(
            WpsAlgorithm(
                ...
                mode = ALGO_MACSN,
                func = { _, ser ->
                    val serial = ser?.replace(NON_DIGIT_REGEX, "") ?: ""
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                func = { mac, ser ->
                    val serial = ser ?: ""
                    val seed =
                        ((mac and 0xFF) + (serial.takeLast(6).toLongOrNull() ?: 0)) % 10000000
                    addChecksum(seed)
                },
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:0C:43", "00:11:2F", "00:13:D4", "00:15:F2", "00:17:31",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:0A:F5", "00:18:82", "00:1E:10", "00:25:68", "00:25:9E",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:0A:EB", "00:11:3B", "00:14:78", "00:19:E0", "00:1D:0F",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:10:18", "00:90:4C", "14:D6:4D", "1C:7E:E5", "28:10:7B",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:19:E4", "00:25:F1", "00:25:F2", "04:5F:A7", "0C:54:A5",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:04:ED", "00:0A:52", "00:11:F6", "00:15:C6", "00:19:70",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:03:C9", "00:08:9B", "00:0E:50", "00:14:7F", "00:17:82",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "40:7B:1B", "48:0B:B2", "4C:E6:C0", "5C:64:8E", "78:1D:BA",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:18:01", "00:1A:1B", "00:1F:90", "00:24:7B", "00:26:42",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:08:27", "00:13:C8", "00:17:C2", "00:19:CB", "00:1C:A2",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:1D:D1", "00:1D:D2", "00:1D:D3", "00:1D:D4", "00:1D:D5",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:00:0A", "00:10:B5", "00:13:F7", "00:1B:FC", "00:22:2D",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:15:CE", "00:1A:DB", "00:26:CE", "00:7C:BF", "40:5D:82",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:08:5C", "00:0A:9B", "00:19:CB", "00:26:B6", "20:76:00",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:22:F7", "00:24:D2", "00:A0:26", "1C:C6:3C", "28:BE:03",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:15:A2", "00:15:A3", "00:15:A4", "00:15:A5", "00:1A:DB",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:00:00", "00:08:27", "00:19:CB", "00:1C:A2", "00:1D:8B",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                func = { mac, _ ->
                    val bytes = macToBytes(mac)
                    val seed =
                        (bytes[3].toLong() shl 24) or (bytes[4].toLong() shl 16) or (bytes[5].toLong() shl 8) or bytes[2].toLong()
                ...
                prefixes = listOf(
                    "00:04:0E", "00:08:54", "00:1F:3F", "00:26:4D", "1C:C6:3C",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:05:C9", "00:0F:E2", "00:19:15", "00:24:FE", "04:C0:6F",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:19:15", "00:19:70", "00:1E:2A", "00:1E:74", "00:1F:9F",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:21:97", "00:E0:4C", "1C:61:B4", "4C:5F:C2", "58:10:8C",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:0D:F0", "00:14:5C", "00:19:77", "00:1B:57", "00:26:8D",
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "04:8D:38", "08:10:79", "C8:3A:35", "CC:96:A0", "D8:32:14",
                    "E4:D3:32", "F4:83:CD"
                ),
        ...
        algorithms.add(
            WpsAlgorithm(
                ...
                prefixes = listOf(
                    "00:22:6B", "00:24:D1", "00:26:42", "00:26:CE", "40:0D:10",
    ...
    private fun addExperimentalStaticPins() {
        algorithms.add(
            WpsAlgorithm(
                "pinLinksysStatic",
                "Linksys Static [EXPERIMENTAL]",
                ALGO_STATIC,
                { _, _ -> 12345678 },
                prefixes = listOf("00:0F:66", "00:14:BF", "00:18:F8", "00:1A:70"),
                description = "[EXPERIMENTAL] Pin = 12345678",
                isExperimental = true
            )
        )
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinTrendnetStatic",
                "Trendnet Static [EXPERIMENTAL]",
                ALGO_STATIC,
                { _, _ -> 12345670 },
                prefixes = listOf("00:14:D1", "D8:EB:97"),
                description = "[EXPERIMENTAL] Pin = 12345670",
                isExperimental = true
            )
        )
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinTendaStatic", "Tenda Static [EXPERIMENTAL]", ALGO_STATIC, { _, _ -> 88888888 },
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinActiontecStatic",
                "Actiontec Static [EXPERIMENTAL]",
                ALGO_STATIC,
                { _, _ -> 25802711 },
                prefixes = listOf("00:1D:1A", "00:18:39"),
                description = "[EXPERIMENTAL] Pin = 25802711",
                isExperimental = true
            )
        )
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinLinksysWRT54G",
                "Linksys WRT54G [EXPERIMENTAL]",
                ALGO_STATIC,
                { _, _ -> 8621690 },
                prefixes = listOf("00:12:17", "00:13:10"),
                description = "[EXPERIMENTAL] Pin = 8621690",
                isExperimental = true
            )
        )
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinNetgearWGR614",
                "Netgear WGR614 [EXPERIMENTAL]",
                ALGO_STATIC,
                { _, _ -> 4030384 },
                prefixes = listOf("00:14:6C", "00:18:4D"),
                description = "[EXPERIMENTAL] Pin = 4030384",
                isExperimental = true
            )
        )
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinHuaweiHG520", "Huawei HG520 [EXPERIMENTAL]", ALGO_STATIC, { _, _ -> 2882813 },
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinZTEZXHN", "ZTE ZXHN [EXPERIMENTAL]", ALGO_STATIC, { _, _ -> 1234567 },
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinSitecomWLR2000",
                "Sitecom WLR-2000 [EXPERIMENTAL]",
                ALGO_STATIC,
                { _, _ -> 1679893 },
                prefixes = listOf("00:0C:F6", "64:D1:A3"),
                description = "[EXPERIMENTAL] Pin = 1679893",
                isExperimental = true
            )
        )
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinONOCBN", "ONO CBN [EXPERIMENTAL]", ALGO_STATIC, { _, _ -> 9575521 },
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinSagemcomFAST", "Sagemcom F@ST [EXPERIMENTAL]", ALGO_STATIC, { _, _ -> 8817524 },
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinComtrendAR", "Comtrend AR/VR [EXPERIMENTAL]", ALGO_STATIC, { _, _ -> 1234567 },
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinHuaweiHG532e", "Huawei HG532e [EXPERIMENTAL]", ALGO_STATIC, { _, _ -> 3425928 },
        ...
        algorithms.add(
            WpsAlgorithm(
                "pinZTEH108N", "ZTE H108N [EXPERIMENTAL]", ALGO_STATIC, { _, _ -> 1234567 },
    ...
    private fun parseBssid(bssid: String): Long? {
        val mac = bssid.split("|")[0].replace(MAC_SEPARATOR_REGEX, "").replace(" ", "")
        return try {
    ...
    fun analyzePins(inputs: List<String>): Map<String, Any> {
        ...
        validInputs.forEach { parsed ->
            ...
            if (mac == null) {
                Log.w(TAG, "Skipping invalid BSSID: ${parsed.bssid}")
                return@forEach
            }
