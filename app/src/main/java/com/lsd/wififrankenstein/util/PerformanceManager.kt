...
object PerformanceManager {
    const val MAX_POINTS_PER_QUERY = 100_000
    const val MAX_SEARCH_RESULTS = 5_000
    ...
    fun initialize(context: Context) {
        ...
        Log.d(
            "PerformanceManager",
            "Available RAM: ${availableMemoryMB}MB, Cores: $coreCount, LowRAM: $isLowRamDevice"
        )
    }
    ...
    fun getMaxPointsPerOperation(): Int {
        return when {
            availableMemoryMB >= 8000 -> MAX_POINTS_PER_QUERY
            availableMemoryMB >= 6000 -> 100000
            availableMemoryMB >= 4000 -> 75000
            availableMemoryMB >= 2000 -> 50000
            availableMemoryMB >= 1000 -> 25000
