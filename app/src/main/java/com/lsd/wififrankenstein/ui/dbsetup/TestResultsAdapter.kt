...
class TestResultsAdapter(private val results: List<Pair<String, Pair<Boolean, String>>>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val testTitle =
            context.getString(R.string.test_title, url.substringAfterLast("/").substringBefore("?"))
            ...
            try {
                ...
                if (result) {
                    resultMessage.append(
                        context.getString(R.string.api_availability_success)
                            .substringBefore("Success")
                    )
                    ...
                    resultMessage.append(
                        context.getString(R.string.api_request_test_success)
                            .substringBefore("Success")
                    )
                    ...
                    resultMessage.append(
                        context.getString(R.string.api_request_test_error).substringBefore("Error")
                    )
