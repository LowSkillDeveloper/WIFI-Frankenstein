...
data class NotificationMessage(
    ...
    fun getLocalizedPrimaryButton(languageCode: String): String {
        return primaryButton[languageCode] ?: primaryButton["en"]
        ?: primaryButton.values.firstOrNull() ?: "OK"
    }

    fun getLocalizedSecondaryButton(languageCode: String): String? {
        return secondaryButton?.get(languageCode) ?: secondaryButton?.get("en")
        ?: secondaryButton?.values?.firstOrNull()
    }
