...
class UpdateChecker(private val context: Context) {
    ...
    companion object {
        ...
        private const val UPDATE_URL =
            "https://github.com/LowSkillDeveloper/WIFI-Frankenstein/raw/service/updates.json"
    }
    ...
    fun checkForUpdates(): Flow<UpdateStatus> = flow {
        ...
        try {
            ...
            if (e::class.java.name == "kotlinx.coroutines.flow.internal.AbortFlowException") throw e
    ...
    private fun checkFileUpdates(json: JSONObject): List<FileUpdateInfo> {
        return try {
            ...
            val serverFilesList = (0 until fileUpdates.length()).mapNotNull { i ->
                try {
            ...
            if (!hasRouterKeygen) {
                ...
                val localVersion = getFileVersion(routerKeygenFileName)
                serverFilesList.add(
                    FileUpdateInfo(
                    ...
                    for (i in 0 until databasesArray.length()) {
                        ...
                        if (serverId == installedDb.idJson) {
                            ...
                            return@mapNotNull SmartLinkDbUpdateInfo(
                                dbItem = installedDb,
                                serverVersion = serverVersion,
                                downloadUrl = info.downloadUrls.firstOrNull() ?: "",
