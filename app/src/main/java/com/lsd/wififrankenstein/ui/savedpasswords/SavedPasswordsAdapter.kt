...
class SavedPasswordsAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(password: SavedWifiPassword) {
            ...
            if (password.isOpenNetwork) {
                ...
                buttonCopyPassword.visibility =
                    if (password.password.isNotEmpty()) View.VISIBLE else View.GONE
            }

            securityText.text =
                itemView.context.getString(R.string.security_type_format, password.securityType)
    ...
    private class DiffCallback : DiffUtil.ItemCallback<SavedWifiPassword>() {
        override fun areItemsTheSame(
            oldItem: SavedWifiPassword,
            newItem: SavedWifiPassword
        ): Boolean {
