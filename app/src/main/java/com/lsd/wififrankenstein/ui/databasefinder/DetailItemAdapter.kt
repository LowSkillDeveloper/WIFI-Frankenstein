...
class DetailItemAdapter :
    ListAdapter<DetailItem, DetailItemAdapter.DetailViewHolder>(DetailDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DetailViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.item_detail_row, parent, false)
    ...
    class DetailViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val textViewKey: TextView = itemView.findViewById(R.id.row_label)
        private val textViewValue: TextView = itemView.findViewById(R.id.row_value)
        private val buttonCopy: MaterialButton = itemView.findViewById(R.id.row_copy_button)
